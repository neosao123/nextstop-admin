$(document).ready(function () {
    ...
    function update_personal_info(formData) {
        var formUrl = `${baseUrl}/driver/verified/${driverId}`;
        $.ajax({
            type: "POST",
            url: formUrl,
            data: formData,
    ...
    $('.document_number').on('input', function () {
        ...
        switch (document_type) {
            ...
            case 'bank_passbook_or_cancel_cheque':
                // Optional field with no specific validation
                regex = /^.*$/;  // Allows any input or can be left empty
                errorMessage = ''; // No error message for optional fields
                break;
        ...
        $('.document_number').each(function () {
            ...
            switch (document_type) {
                ...
                case 'driving_license':
                    ...
                    break;
                case 'bank_passbook_or_cancel_cheque':
                    // Skip validation for cancel_cheque if it's empty
                    regex = /^$/;
                    break;
                default:
                    regex = /.*/;
    ...
    function update_vehicle_info(formData) {
        var formUrl = `${baseUrl}/driver/verified/vehicle-information/${driverId}`;
        $.ajax({
            type: "POST",
            url: formUrl,
            data: formData,
    ...
    function verify_personal_document_info(formData) {
        var formUrl = `${baseUrl}/driver/verified/verify/${driverId}`;
        $.ajax({
            type: "POST",
            url: formUrl,
            data: formData,
    ...
    function admin_verify(formData) {
        var formUrl = `${baseUrl}/driver/verified/admin-verify/${driverId}`;
        $.ajax({
            type: "POST",
            url: formUrl,
            data: formData,
    ...
    function verify_vehicle_document_info(formData) {
        var formUrl = `${baseUrl}/driver/verified/vehicle-information/verify/${driverId}`;
        $.ajax({
            type: "POST",
            url: formUrl,
            data: formData,
    ...
    function verify_training_video_info(formData) {
        ...
        var formUrl = `${baseUrl}/driver/verified/training-video-verify/${driverId}`;
        $.ajax({
            type: "POST",
            url: formUrl,
            data: formData,
