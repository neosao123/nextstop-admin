@php
  $pageTitle = __('index.add_training_video');
@endphp
...
@section('content')
  <div class="d-flex mb-4 mt-1">
    ...
    <div class="col">
      <h5 class="mb-0 text-primary position-relative"><span class="bg-200 dark__bg-1100 pe-3">{{ __('index.add_training_video') }}</span><span
  ...
  <div class="col-lg-12">
    <div class="card mb-3">
      <form class="" id="form-add-training-video" method="POST" action="{{ url('training-video') }}" enctype="multipart/form-data">
        @csrf
        <div class="card-header bg-light">
          <h5 class="mb-0" id="form-title">{{ __('index.add_training_video') }}</h5>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
              <label class="form-label">{{ __('index.video_title') }} <span class="text-danger">*</span></label>
              <input type="text" class="form-control mb-2" name="video_title" id="video_title" value="{{ old('video_title') }}" />
              @error('video_title')
			...
			<div class="col-lg-4 col-md-6 col-sm-12 mb-3">
              ...
              <input type="number"  class="form-control mb-2" name="total_video_time_length" id="total_video_time_length" value="{{ old('total_video_time_length') }}" />
		  ...
		  <div class="row">
			<div class="col-lg-4 col-md-6 col-sm-12 mb-3">
				<div class="mb-3">
					<label class="form-label">{{__('index.video')}} <span class="text-danger">*</span></label>
			...
			<div class="col-lg-4 col-md-6 col-sm-12 mb-3">
				<div class="mb-3">
					<label class="form-label">{{__('index.thumbnail')}} <span class="text-danger">*</span></label>
        ...
        <div class="card-footer bg-light text-end">
          <button class="btn btn-primary" type="submit" id="submit">{{ __('index.save') }}</button>
...
@push('scripts')
  ...
  <script src="{{ asset('site-plugins/training-video/add.js?v=' . time()) }}"></script>
@endpush
