@php
  $pageTitle = __('index.view_or_edit_verified_driver');
@endphp
...
@section('content')
  <div class="d-flex mb-4 mt-1">
    ...
    <div class="col">
      <h5 class="mb-0 text-primary position-relative"><span class="bg-200 dark__bg-1100 pe-3">{{ __('index.view_or_edit_verified_driver') }}</span><span
          class="border position-absolute top-50 translate-middle-y w-100 start-0 z-index--1"></span></h5>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}" class="text-decoration-none text-dark">Dashboard</a></li>
          <li class="breadcrumb-item"><a href="{{ url('/driver/verified') }}" class="text-decoration-none text-dark">{{ __('index.verified_driver') }}</a></li>
          <li class="breadcrumb-item active" aria-current="page">{{ __('index.view_or_edit_verified_driver') }}</li>
        </ol>
      </nav>
    </div>
    <div class="col-auto ms-2 align-items-center">
      <a class="btn btn-falcon-default btn-sm me-1 mb-1" href="{{ url('driver/verified') }}">
...
@push('scripts')
  ...
  <script src="{{ asset('site-plugins/verified-driver/edit.js?v=' . time()) }}"></script>
@endpush
