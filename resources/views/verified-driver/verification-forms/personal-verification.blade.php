      ...
      <div class="col-lg-4 col-md-6 col-sm-12 mb-2">
        ...
        @if (isset($driver->driver_photo) && !empty($driver->driver_photo))
          ...
          <div class="d-flex align-items-center">
            ...
            <a data-url="{{ url('driver/verified/driver-photo/delete/' . $driver->id) }}" class="text-danger deleteDriverPhoto d-none mx-2">
            ...
            <div class="row align-items-start">
              <div class="col-lg-4 col-md-6 col-sm-12 mb-2 backend-image-file">
                ...
                @if (isset($value->document_1) && $value->document_1 != '')
                  ...
                  <a data-document-count="1" data-url="{{ url('driver/verified/personal-document/delete/' . $value->id) }}" class="text-danger deletePersonalDocument d-none mx-2">
                    <span class="fas fa-trash-alt"></span>
                  </a>
                @else
              ...
              @if ($value->document_type == 'aadhar_card')
                <div class="col-lg-4 col-md-6 col-sm-12 mb-2 backend-image-file">
                  ...
                  @if (isset($value->document_2) && $value->document_2 != '')
                    ...
                    <a data-document-count="2" data-url="{{ url('driver/verified/personal-document/delete/' . $value->id) }}" class="text-danger deletePersonalDocument d-none mx-2">
                      <span class="fas fa-trash-alt"></span>
                    </a>
                  @else
                    <!-- No document uploaded -->
          ...
          <div class="row align-items-start">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 mb-2 backend-image-file">
              ...
              @if (isset($value->document_file_path) && $value->document_file_path != '')
                ...
                <a data-url="{{ url('driver/verified/vehicle-document/delete/' . $value->id) }}" class="text-danger deleteVehicleDocument d-none mx-2">
                  <span class="fas fa-trash-alt"></span>
                </a>
              @else
                <!-- No document uploaded -->
