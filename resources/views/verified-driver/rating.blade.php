...
<div class="d-flex mb-4 mt-1" id="sel-projectId">
    ...
    <div class="col-auto ms-2 align-items-center">
        <a href="{{ url('driver/verified') }}" class="btn btn-falcon-primary btn-sm me-1 mb-1">{{__('index.back')}}</a>
    </div>
    ...
    <div class="col-12">
        <div class="card mb-3">
            <div class="card-body row">
				<input type="hidden" id="driver" value="{{$driverId}}">
				<!-- Driver Field -->
				<div class="col-lg-3 col-md-6 col-sm-12 pb-2">
					<label class="form-label">{{__('index.customer')}}</label>
					<select class="form-control select2 custom-select" id="customer" name="customer">
					</select>
				</div>
...
<script src="{{ asset('assets/vendors/select2/select2.min.js') }}"></script>
 <script src="{{ asset('assets/vendors/datatable1.13.8/jquery.dataTables.js') }}"></script>
  ...
  <script src="{{ asset('site-plugins/verified-driver/rating.js?v=' . time()) }}"></script>
@endpush