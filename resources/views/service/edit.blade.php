@php
  $pageTitle = __('index.edit_service');
@endphp
...
@section('content')
  ...
  <div class="col-lg-12">
    <div class="card mb-3">
      <form id="form-edit-service" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card-header bg-light">
          <h5 class="mb-0">{{ __('index.edit_service') }}</h5>
        </div>
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 mb-3">
              ...
              <textarea class="form-control" name="service_description" id="service_description">{{ old('service_description', $service->service_description) }}</textarea>
            </div>
            <!-- Service Icon -->
            <div class="col-lg-12 col-md-12 col-sm-12 mb-3 position-relative">
              ...
              <input type="file" class="form-control" name="service_icon" id="service_icon" accept=".jpg, .jpeg, .png" />
        ...
        <div class="card-footer bg-light text-end">
          <button class="btn btn-primary" id="service-update" type="button">{{ __('index.update') }}</button>
        </div>
      </form>
...
@push('scripts')
  ...
  <script src="{{ asset('site-plugins/service/edit.js?v=' . time()) }}"></script>
@endpush
