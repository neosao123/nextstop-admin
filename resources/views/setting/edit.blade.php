...
@section('content')
  <div class="d-flex mb-4 mt-1">
    ...
    <div class="col">
      <h5 class="mb-0 text-primary position-relative"><span class="bg-200 dark__bg-1100 pe-3">{{ __('index.edit_setting') }}</span><span
    ...
    <div class="card mb-3">
      <form class="" id="form-edit-goods-type" method="POST" action="{{ url('setting/' . $setting->id) }}">
        ...
        <div class="card-header bg-light">
          <h5 class="mb-0" id="form-title">{{ __('index.edit_setting') }}</h5>
        </div>
        <div class="card-body">
          <div class="row">
