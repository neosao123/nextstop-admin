...
@section('content')
  ...
  <!-- Add Customer Rejection Reason -->
  <div class="col-lg-12">
    <div class="card mb-3">
      <form class="" action="{{ url('customer-rejection-reason') }}" id="form-add-customer-reason" method="POST">
        @csrf
        @method('post')
        <div class="card-header bg-light">
          <h5 class="mb-0" id="form-title">{{ __('index.add_customer_rejection_reason') }}</h5>
        </div>
        <div class="card-body">
          <div class="row">
...
@push('scripts')
  ...
  <script src="{{ asset('site-plugins/customer-rejection-reason/add.js?v=' . time()) }}"></script>
@endpush
