...
@section('content')
    ...
    <div class="col">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          @endif
          <li class="breadcrumb-item active" aria-current="page">{{ __('index.import_customer_rejection_reason') }}</li>
        </ol>
      </nav>
    </div>
    @if (Auth::guard('admin')->user()->can('Customer-Reason.List', 'admin'))
  ...
  <div class="col-lg-12">
    <div class="card mb-3">
        ...
        <div class="card-body">
          <div class="text-danger">
            ...
            <ul class="" type="">
              ...
              <li>
                <p class="mb-2">{{ __('index.the_status_field_always_contains') }}<strong>active </strong>&nbsp{{ __('index.or') }}<strong> inactive </strong> {{ __('index.keyword') }}</p>
              </li>
            </ul>
          </div>
          <form action="{{ url('/customer-rejection-reason/upload/excel') }}" method="post" enctype="multipart/form-data" data-parsley-validate="" id="matform">
            @csrf
            <div class="row">
              ...
              <div class="col-md-6 form-group mt-2">
                <label></label>
                <div class="form-group">
                  <button class="btn btn-primary" type="button" id="upload" onclick="Upload()">{{ __('index.upload') }}</button>
     ...
     <div class="card d-none" id="customerRejectionReasonList">
			  ...
			  <div class="col-sm-12">
				...
				<form id="submitForm" method="post" name="s" enctype="multipart/form-data">
				  ...
				  <div class="card-body">
					...
					<button type="submit" name="submit" id="dataSubmit" class="btn btn-success">{{ __('index.submit') }}</button>
...
<script type="text/javascript" src="{{ asset('assets/js/jszip.js') }}"></script>
  ...
  <script src="{{ asset('site-plugins/customer-rejection-reason/import.js?v=' . time()) }}"></script>
@endpush
