@extends('layout.master', ['pageTitle' => __('index.add_user')])
@push('styles')
...
<div class="d-flex mb-4 mt-1">
    ...
    <div class="col">
        <div class="">
            <h5 class="mb-0 text-primary position-relative"><span class="bg-200 dark__bg-1100 pe-3">{{__('index.add_user')}}</span><span class="border position-absolute top-50 translate-middle-y w-100 start-0 z-index--1"></span></h5>
...
<!--ADD USER-->
 <div class="col-lg-12">
    <div class="card mb-3">
      <form class="" id="form-add-user" method="POST" action="{{ url('users') }}" enctype="multipart/form-data">
        @csrf
        <div class="card-header bg-light">
          <h5 class="mb-0" id="form-title">{{ __('index.add_user')}}</h5>
        </div>
        <div class="card-body"> 
          <div class="row">
            <!-- Role -->
			...
			<div class="col-lg-4 col-md-6 col-sm-12 mb-3">
			  ...
			  <input type="text" class="form-control mb-2" name="first_name" id="first_name" value="{{ old('first_name') }}" />
			   @error('first_name')
			...
			<div class="col-lg-4 col-md-6 col-sm-12 mb-3">
			  ...
			  <input type="text" class="form-control mb-2" name="last_name" id="last_name" value="{{ old('last_name') }}" />
			    @error('last_name')
                <span class="text-danger backend-error">{{ $message }}</span>
              @enderror
			</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-12 mb-3">
			  ...
			  <input type="number" class="form-control mb-2" name="phone_number" id="phone_number" value="{{ old('phone_number') }}" />
			  @error('phone_number')
                <span class="text-danger backend-error">{{ $message }}</span>
              @enderror
			</div>
			<!-- Password -->
			<div class="col-lg-4 col-md-6 col-sm-12 mb-3">
			  <label class="form-label">{{__('index.password')}}<span class="text-danger">*</span></label>
			...
			<div class="col-lg-4 col-md-6 col-sm-12 mb-3">
			  <label class="form-label">{{__('index.password_confirmation')}}<span class="text-danger">*</span></label>
			...
			<div class="col-lg-4 col-md-6 col-sm-12 mb-3">
				<img class="img-radius" id="showImage" 
					 src="{{asset('/assets/img/user/default-user.png') }}" 
					 height="80" width="80" /> 
            </div>					 
          </div>
          <div>
        ...
        <div class="card-footer bg-light text-end">
           <button class="btn btn-primary" id="vehicle-type-save" type="submit">{{ __('index.save') }}</button>
...
@push('scripts')
 ...
 <script src="{{ asset('site-plugins/user/add.js?v=' . time()) }}"></script>
@endpush