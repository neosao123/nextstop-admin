@php
  $pageTitle = __('index.import_vehicle');
@endphp
...
@section('content')
  <div class="d-flex mb-4 mt-1">
    ...
    <div class="col">
      <h5 class="mb-0 text-primary position-relative"><span class="bg-200 dark__bg-1100 pe-3">{{ __('index.import_vehicle') }}</span><span
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          @if (Auth::guard('admin')->user()->can('Vehicle.List'))
            <li class="breadcrumb-item"><a href="{{ url('/vehicle') }}" class="text-decoration-none text-dark">{{ __('index.vehicle') }}</a></li>
          @endif
          <li class="breadcrumb-item active" aria-current="page">{{ __('index.import_vehicle') }}</li>
        </ol>
      </nav>
    </div>
    @if (Auth::guard('admin')->user()->can('Vehicle.List.List'))
  ...
  <div class="row gx-3">
    <div class="col-lg-12">
        ...
        <div class="card-body">
          <div class="text-danger">
            ...
            <ul class="" type="">
              ...
              <li>
                <p class="mb-2">{{ __('index.vehicle_type_id_instruction') }}</p>
              </li>
              <li>
          ...
          <form action="{{ url('/vehicle/upload/excel') }}" method="post" enctype="multipart/form-data" data-parsley-validate="" id="matform">
            @csrf
            <div class="row">
      ...
      <div class="card mb-3 d-none" id="vehicleList">
        <div class="card-header bg-light">
          <h5 class="mb-0">{{ __('index.vehicle') . ' ' . __('index.list') }}</h5>
        </div>
        ...
        <form id="submitForm" method="post" name="s" enctype="multipart/form-data">
          ...
          <div class="card-body bg-white">
            ...
            <div id="dvExcel" class="table-responsive mb-2"></div>
...
@push('scripts')
  ...
  <script src="{{ asset('site-plugins/vehicle/import.js?v=' . time()) }}"></script>
@endpush
