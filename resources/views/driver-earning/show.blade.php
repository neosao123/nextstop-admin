...
<div class="d-flex mb-4 mt-1">
        ...
        <div class="">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    @endif
                    @if(Auth::guard('admin')->user()->can('Driver Earning.List', 'admin'))
                    <li class="breadcrumb-item"><a href="{{ url('/driver-earning') }}" class="text-decoration-none text-dark">{{__('index.driver_payment_requests')}}</a></li>
                    @endif
    ...
    <div class="col-auto ms-2 align-items-center">
        <a href="{{ url('driver-earning') }}" class="btn btn-falcon-primary btn-sm me-1 mb-1">{{__('index.back')}}</a>
    </div>
    @endif
</div>
<!--ADD USER-->
