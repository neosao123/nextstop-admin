@extends('layout.master', ['pageTitle' => __('index.view_cancel_trip')])
@push('styles')
    ...
    <div class="d-flex mb-4 mt-1">
        ...
        <div class="col">
            <div class="">
                <h5 class="mb-0 text-primary position-relative"><span
                        class="bg-200 dark__bg-1100 pe-3">{{ __('index.view_cancel_trip') }}</span><span
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        @if (Auth::guard('admin')->user()->can('Cancel Trip.List', 'admin'))
                            <li class="breadcrumb-item"><a href="{{ url('/cancel-trips') }}"
                                    class="text-decoration-none text-dark">{{ __('index.cancel_trips') }}</a></li>
                        @endif
        ...
        @if (Auth::guard('admin')->user()->can('Cancel Trip.List', 'admin'))
            <div class="col-auto ms-2 align-items-center">
                <a href="{{ url('cancel-trips') }}"
                    class="btn btn-falcon-primary btn-sm me-1 mb-1">{{ __('index.back') }}</a>
            </div>
        @endif
    </div>
    <!--View Trip-->
            ...
            <form>
                ...
                <div class="card-body">
                    <div class="row"> 
                        ...
                        <!-- Trip Cancel Time -->
                        <div class="col-lg-4 col-md-4 col-sm-12 mb-3 d-none">
                            <label class="form-label">{{ __('index.cancellation_time') }}</label>
                            <input type="text" class="form-control mb-2" name="trip_cancel_time"
                                id="trip_cancel_time"
                                value="{{ \Carbon\Carbon::parse($trip->cancel_time)->format('d-m-Y h:i A') }}" readonly />
                        ...
                        @if ($penalty)
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
                                ...
                                <input type="text" class="form-control mb-2" name="trip_penalty_amount"
                                    id="trip_penalty_amount" value="{{ $penalty->amount }}" readonly />
                        ...
                        @if ($customerPenalty)
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
                                ...
                                <input type="text" class="form-control mb-2" name="customer_penalty"
                                    id="customer_penalty" value="{{ $customerPenalty->amount }}" readonly />
                        ...
                        @if ($refundAmount)
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
                                ...
                                <input type="text" class="form-control mb-2" name="customer_refund"
                                    id="customer_refund" value="{{ $refundAmount->amount }}" readonly />
