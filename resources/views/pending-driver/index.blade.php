@php
    $pageTitle = __('index.pending_driver');
@endphp
    ...
    <div class="d-flex mb-4 mt-1">
        ...
        <div class="col">
            <h5 class="mb-0 text-primary position-relative"><span
                    class="bg-200 dark__bg-1100 pe-3">{{ __('index.pending_driver') }}</span><span
                    class="border position-absolute top-50 translate-middle-y w-100 start-0 z-index--1"></span></h5>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}"
                            class="text-decoration-none text-dark">{{ __('index.dashboard') }}</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{ __('index.pending_driver') }}</li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 mb-2">
                                ...
                                <select class="cutsom-select select-2 form-control" name="search_account_status"
                            ...
                            <!--<div class="col-lg-4 col-md-6 col-sm-12 mb-2">
                        <label class="form-label">{{ __('index.verification_status_type') }}</label>
                        <select class="custom-select select-2 form-control" name="search_verification_status_type[]" id="search_verification_status_type" multiple>
                          <option value=""></option>
                          <option value="document">Document Verification</option>
                          <option value="vehicle">Vehicle Verification</option>
                          <option value="training-video">Training Video Verification</option>
                        </select>
                      </div>-->
                            <div class="col-lg-4 col-md-6 col-sm-12 mb-2">
                                <label class="form-label">{{ __('index.verification_status') }}</label>
                                <select class="cutsom-select select-2 form-control" name="search_verification_status"
                                    id="search_verification_status">
                                    <option value="">Select Status</option>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="table-responsive scrollbar">
                            <table id="dt-pending-driver" class="table table-hover">
                                <thead>
                                    <tr>
                                        @if (Auth::guard('admin')->user()->canany(['Pending-Driver.View-Edit', 'Pending-Driver.Delete', 'Pending-Driver.Block']))
...
@push('scripts')
    ...
    <script src="{{ asset('site-plugins/pending-driver/index.js?v=' . time()) }}"></script>
@endpush
