...
<div class="d-flex mb-4 mt-1">
    ...
    @if(Auth::guard('admin')->user()->can('Customer.Wallet-Transaction', 'admin'))
    <div class="col-auto ms-2 align-items-center">
        <a href="{{ url('customers/wallet-transaction/' .$walletTransaction->customer_id) }}" class="btn btn-falcon-primary btn-sm me-1 mb-1">{{__('index.back')}}</a>
    </div>
    @endif
</div>
<!--ADD USER-->
      ...
      <form >
        ...
        <div class="card-body"> 
          <div class="row">
            ...
            @if($walletTransaction->payment_mode=="online")
            <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
			  <label class="form-label">{{__('index.payment_order_id')}}</label>
			  <input type="text" class="form-control mb-2" name="payment_order_id" id="payment_order_id" value="{{$walletTransaction->payment_order_id }}" readonly />
			</div>
            @endif
          </div>
      </form>
