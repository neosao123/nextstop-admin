...
@section('content')
  <div class="d-flex mb-4 mt-1">
    ...
    <div class="col">
      <h5 class="mb-0 text-primary position-relative"><span class="bg-200 dark__bg-1100 pe-3">{{ __('index.goods_type') }}</span><span
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          @endif
          <li class="breadcrumb-item active" aria-current="page">{{ __('index.goods_type') }}</li>
        </ol>
      </nav>
    </div>
    @if (Auth::guard('admin')->user()->can('Goods-Type.Create'))
      <div class="col-auto ms-2 align-items-center">
        <a class="btn btn-falcon-primary btn-sm me-1 mb-1" href="{{ url('goods-type/create') }}">
          <span class="px-2">{{ __('index.add_goods_type') }}</span>
        </a>
      </div>
    @endif
  </div>
      ...
      <div class="col-lg-12">
        <div class="card mb-3">
          <div class="card-header bg-light d-flex">
            ...
            @if (Auth::guard('admin')->user()->can('Goods-Type.Import'))
              <div class="col-auto ms-2 align-items-center">
                ...
                <a class="btn btn-falcon-success btn-sm me-1 mb-1" href="{{ url('goods-type/import/excel') }}">
          ...
          <div class="card-body">
            <div class="table-responsive scrollbar">
              <table id="dt-goods-type" class="table table-hover">
                <thead>
                  <tr>
                     @if (Auth::guard('admin')->user()->canany(['Goods-Type.Edit', 'Goods-Type.Delete', 'Goods-Type.View']))
                      <th class="text-start" scope="col">{{ __('index.action') }}</th>
                    @endif
                    <th scope="col">{{ __('index.goods_type') }}</th>
...
@push('scripts')
  ...
  <script src="{{ asset('site-plugins/goods-type/index.js?v=' . time()) }}"></script>
@endpush
